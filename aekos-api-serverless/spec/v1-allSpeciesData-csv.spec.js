...
describe('v1-allSpeciesData-csv', () => {
  ...
  describe('.getCsvDownloadFileName()', () => {
    it('should return null when no query parameters are present', () => {
      ...
      let result = objectUnderTest._testonly.getCsvDownloadFileName(event)

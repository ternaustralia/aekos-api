...
import au.org.aekos.api.service.metric.JenaMetricsStorageServiceTest;
import au.org.aekos.api.util.WinCRUtil;
...
public class TestUtils {
	...
	private static String load(String filename) {
		InputStream in = JenaMetricsStorageServiceTest.class.getClassLoader().getResourceAsStream("au/org/aekos/api/" + filename);
		try {
